...
tf2_dict = {
    "from": 0.015151515151515152,
    "time": 0.015151515151515152,
    "to": 0.03787878787878788,
    "this": 0.007575757575757576,
    "submerged": 0.007575757575757576,
    "or": 0.007575757575757576,
    "latent": 0.007575757575757576,
    "theater": 0.007575757575757576,
    "in": 0.022727272727272728,
    "becomes": 0.007575757575757576,
    "almost": 0.007575757575757576,
    "overt": 0.007575757575757576,
    "it": 0.015151515151515152,
    "is": 0.022727272727272728,
    "close": 0.007575757575757576,
    "the": 0.07575757575757576,
    "surface": 0.015151515151515152,
    "hamlets": 0.007575757575757576,
    "pretense": 0.007575757575757576,
    "of": 0.05303030303030303,
    "madness": 0.007575757575757576,
    "antic": 0.007575757575757576,
    "disposition": 0.007575757575757576,
    "he": 0.022727272727272728,
    "puts": 0.007575757575757576,
    "on": 0.007575757575757576,
    "protect": 0.007575757575757576,
    "himself": 0.015151515151515152,
    "and": 0.03787878787878788,
    "prevent": 0.007575757575757576,
    "his": 0.022727272727272728,
    "antagonists": 0.007575757575757576,
    "plucking": 0.007575757575757576,
    "out": 0.015151515151515152,
    "heart": 0.007575757575757576,
    "mystery": 0.007575757575757576,
    "even": 0.007575757575757576,
    "closer": 0.007575757575757576,
    "when": 0.015151515151515152,
    "hamlet": 0.015151515151515152,
    "enters": 0.007575757575757576,
    "mothers": 0.007575757575757576,
    "room": 0.007575757575757576,
    "holds": 0.007575757575757576,
    "up": 0.007575757575757576,
    "side": 0.015151515151515152,
    "by": 0.015151515151515152,
    "pictures": 0.007575757575757576,
    "two": 0.007575757575757576,
    "kings": 0.007575757575757576,
    "old": 0.007575757575757576,
    "claudius": 0.007575757575757576,
    "proceeds": 0.007575757575757576,
    "describe": 0.007575757575757576,
    "for": 0.022727272727272728,
    "her": 0.007575757575757576,
    "true": 0.007575757575757576,
    "nature": 0.007575757575757576,
    "choice": 0.007575757575757576,
    "she": 0.007575757575757576,
    "has": 0.007575757575757576,
    "made": 0.007575757575757576,
    "presenting": 0.007575757575757576,
    "truth": 0.007575757575757576,
    "means": 0.007575757575757576,
    "a": 0.007575757575757576,
    "show": 0.007575757575757576,
    "similarly": 0.007575757575757576,
    "leaps": 0.007575757575757576,
    "into": 0.007575757575757576,
    "open": 0.007575757575757576,
    "grave": 0.007575757575757576,
    "at": 0.007575757575757576,
    "ophelias": 0.007575757575757576,
    "funeral": 0.007575757575757576,
    "ranting": 0.007575757575757576,
    "high": 0.007575757575757576,
    "heroic": 0.007575757575757576,
    "terms": 0.007575757575757576,
    "acting": 0.007575757575757576,
    "laertes": 0.007575757575757576,
    "perhaps": 0.007575757575757576,
    "as": 0.007575757575757576,
    "well": 0.007575757575757576,
    "folly": 0.007575757575757576,
    "excessive": 0.007575757575757576,
    "melodramatic": 0.007575757575757576,
    "expressions": 0.007575757575757576,
    "grief": 0.007575757575757576,
}
...
tfidf_list = [
    ...
    ("the", 0.0),
    ("to", 0.0),
    ("a", 0.0007341667652125487),
    ("acting", 0.0007341667652125487),
    ("almost", 0.0007341667652125487),
    ("choice", 0.0007341667652125487),
    ("expressions", 0.0007341667652125487),
    ("grave", 0.0007341667652125487),
    ("has", 0.0007341667652125487),
    ("her", 0.0007341667652125487),
    ("into", 0.0007341667652125487),
    ("laertes", 0.0007341667652125487),
    ("made", 0.0007341667652125487),
    ("mothers", 0.0007341667652125487),
    ("ophelias", 0.0007341667652125487),
    ("pictures", 0.0007341667652125487),
    ("she", 0.0007341667652125487),
    ("show", 0.0007341667652125487),
    ("theater", 0.0007341667652125487),
    ("true", 0.0007341667652125487),
    ("truth", 0.0007341667652125487),
    ("two", 0.0007341667652125487),
    ("hamlet", 0.0014683335304250973),
    ("when", 0.0014683335304250973),
    ("antagonists", 0.0016806723455784576),
    ("antic", 0.0016806723455784576),
    ("at", 0.0016806723455784576),
    ("claudius", 0.0016806723455784576),
    ("describe", 0.0016806723455784576),
    ("disposition", 0.0016806723455784576),
    ("enters", 0.0016806723455784576),
    ("even", 0.0016806723455784576),
    ("excessive", 0.0016806723455784576),
    ("folly", 0.0016806723455784576),
    ("funeral", 0.0016806723455784576),
    ("grief", 0.0016806723455784576),
    ("hamlets", 0.0016806723455784576),
    ("heart", 0.0016806723455784576),
    ("heroic", 0.0016806723455784576),
    ("high", 0.0016806723455784576),
    ("holds", 0.0016806723455784576),
    ("kings", 0.0016806723455784576),
    ("leaps", 0.0016806723455784576),
    ("madness", 0.0016806723455784576),
    ("means", 0.0016806723455784576),
    ("melodramatic", 0.0016806723455784576),
    ("mystery", 0.0016806723455784576),
    ("nature", 0.0016806723455784576),
    ("old", 0.0016806723455784576),
    ("on", 0.0016806723455784576),
    ("open", 0.0016806723455784576),
    ("perhaps", 0.0016806723455784576),
    ("plucking", 0.0016806723455784576),
    ("presenting", 0.0016806723455784576),
    ("pretense", 0.0016806723455784576),
    ("prevent", 0.0016806723455784576),
    ("proceeds", 0.0016806723455784576),
    ("protect", 0.0016806723455784576),
    ("puts", 0.0016806723455784576),
    ("ranting", 0.0016806723455784576),
    ("room", 0.0016806723455784576),
    ("similarly", 0.0016806723455784576),
    ("terms", 0.0016806723455784576),
    ("up", 0.0016806723455784576),
    ("well", 0.0016806723455784576),
    ("for", 0.002202500295637646),
    ("he", 0.002202500295637646),
    ("his", 0.002202500295637646),
    ("in", 0.002202500295637646),
    ("is", 0.002202500295637646),
    ("becomes", 0.0030146970353942242),
    ("close", 0.0030146970353942242),
    ("closer", 0.0030146970353942242),
    ("latent", 0.0030146970353942242),
    ("or", 0.0030146970353942242),
    ("overt", 0.0030146970353942242),
    ("submerged", 0.0030146970353942242),
    ("this", 0.0030146970353942242),
    ("by", 0.003361344691156915),
    ("from", 0.003361344691156915),
    ("himself", 0.003361344691156915),
    ("it", 0.003361344691156915),
    ("out", 0.003361344691156915),
    ("side", 0.003361344691156915),
    ("of", 0.00513916735648784),
    ("surface", 0.0060293940707884484),
    ("time", 0.0060293940707884484),
]
...
class TestTFIDF(unittest.TestCase):
    ...
    def test_idf2(self):
        text_files = [
            "tests/student_tests/test1a.txt",
    ...
    def test_tfidf_big(self):
        ...
        text_files = [
            "tests/student_tests/test1a.txt",
            "tests/student_tests/test1b.txt",
            "tests/student_tests/test2a.txt",
            "tests/student_tests/test2b.txt",
            "tests/student_tests/test3a.txt",
        ]
        result = ds.get_tfidf(text_file, text_files)
        expected = tfidf_list
        self.assertListAlmostEqual(result, expected)
...
point_values = {
    "test_prep_hello_world": 0.05,
    "test_prep_all_whitespace": 0.05,
    "test_prep_1a": 0.1,
    "test_frequency_word_hello": 0.2,
    "test_frequency_hello_world": 0.2,
    "test_frequency_1a": 0.2,
    "test_frequency_1b": 0.2,
    "test_letter_frequency_1": 0.2,
    "test_letter_frequency_4": 0.2,
    "test_similarity_words1": 0.2,
    "test_similarity_words2": 0.2,
    "test_similarity_words3": 0.2,
    "test_similarity_words4": 0.2,
    "test_similarity_letters_1": 0.2,
    "test_similarity_letters_2": 0.2,
    "test_words1": 0.3,
    "test_words2": 0.3,
    "test_tf1": 0.2,
    "test_tf2": 0.2,
