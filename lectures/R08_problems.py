...
def sum_series(n):
    if n - 2 == 0:
        ...
        return n + 1  # if only n, you're "leaving 1 behind"
    else:
...
##############################################################################
# Problem 4: Write a recursive program to calculate the nth harmonic number
def harmonic(n):
    if n == 1:
        return 1
    else:
        return 1 / n + harmonic(
            n - 1
        )  # not 1 / harmonic(n - 1); fn already returns 1/n
...
def gcd(a, b):
    if a % b == 0:
        ...
        return a % b  # how is this recursion?
