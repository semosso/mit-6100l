...
w_two = Workout("Jan 1 2021 3:35 PM", "Jan 1 2021 4 PM", calories=300)
...
# print(w1.get_calories()) # 100.0
# print(w1.get_elev()) # error

w2 = Workout("9/30/2021 2:20 PM", "9/30/2021 2:50 PM", 450)
# # what is the calories val through get_calories()
# # what is the elevation val through get_elev()
# print(w2.get_calories()) # 450
# print(w2.get_elev()) # error

rw1 = RunWorkout("9/30/2021 2:20 PM", "9/30/2021 2:50 PM", 250)
# # what is the calories val through get_calories()
# # what is the elevation val through get_elev()
# print(rw1.get_calories()) # 100
# print(rw1.get_elev()) # 250

rw2 = RunWorkout("9/30/2021 2:20 PM", "9/30/2021 2:50 PM", 450, 700)
# # what is the calories val through get_calories()
# # what is the elevation val through get_elev()
# print(rw2.get_calories()) # 700
# print(rw2.get_elev()) # 450

rw3 = RunWorkout("9/30/2021 2:20 PM", "9/30/2021 2:50 PM", calories=300)
# # what is the calories val through get_calories()
# # what is the elevation val through get_elev()
# print(rw3.get_calories()) # 300
# print(rw3.get_elev()) # 0
...
run1 = RunWorkout(
    "9/30/2021 1:35 PM", "9/30/2021 3:57 PM", 100, route_gps_points=points
)
...
def total_elapsed_time(L):
    ...
    t_diff = [(parser.parse(e[1]) - parser.parse(e[0])).total_seconds() for e in L]
    return sum(t_diff)
...
# finger exercise:
# In this problem, you will implement two classes according to the specification
# below: one `Container` class and one `Queue` class (a subclass of `Container`).
...
# method will be inherited by the subclass. We now want to create a subclass so
# that we can add more functionality – the ability to remove elements from the
# list. A `Queue` will add elements to the list in the same way, but will behave
#  differently when removing an element.

# A queue is a first-in, first-out data structure. Think of a store checkout
# queue. The customer who has been in the line the longest gets the next available
# cashier. When implementing your `Queue` class, you will have to think about``
# which end of your list contains the element that has been in the list the
# longest. This is the element you will want to remove and return.
