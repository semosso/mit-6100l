...
def is_pal(x):
    ...
    if temp == x:
        ...
        return False
    # VAO: bug comes from aliasing `temp = x`, will always return True
    # also, temp.reverse is missing the (), so it doesn't call the method
...
# VAO: my code; solution inverts len() and type(), I get a TypeError that way
print([e[1] for e in L if (type(e) is str and len(e) == 3)])  #
